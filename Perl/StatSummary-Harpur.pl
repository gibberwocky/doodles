...
# Header
print "ID\tTOTAL_READS\tMAPPED_IN_PAIR\tSINGLETONS\tDUPLICATION\tHQ_ALIGNED\tDEPTH_COV\tCALLABLE\tNO_COV\tLOW_COV\tEXCESS_COV\tMQ_POOR\tSNPS_GATK\tSNPS_PILEUP\tSNPS_PLATYPUS\tBAYSIC_GATK\tBAYSIC_PILEUP\tBAYSIC_PLATYPUS\tBAYSIC_FINAL\n";
