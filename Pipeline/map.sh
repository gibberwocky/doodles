...
# ==============================================================================
echo -e "\n\e[1m\e[34m====================================\e[0m"
echo -e "\e[93m\e[1mSeqApiPop\e[0m\e[93m: Mapping\e[0m"
echo -e "\e[1m\e[34m====================================\e[0m"
usage()
{
  echo -e "\n\e[96mUsage\e[0m"
  echo -e "\e[92m   $0 -s <sample name> -f <path to fastq.gz files> -o <output path> [options]\e[0m"
  echo -e "\n\e[96mDetails\e[0m"
  echo -e "\e[92mThis pipeline has been developed to map Illumina HiSeq reads generated for the SeqApiPop project. All of the parameters in the parameter file require setting.\e[0m"
  echo -e "\n\e[96mOPTIONS:\e[0m"
  echo -e "\e[92m\t-i <str>\tPath to input file containing pipeline parameters [defafult = /save/seqapipop/Scripts/params]\e[0m"
  echo -e "\e[92m\t-b <int>\tNumber of bootstrap iterations during BQSR [default = 2]\e[0m"
  echo -e "\e[92m\t-p <T/F>\tReads are paired [Default = T]\e[0m"
  echo -e "\e[92m\t-q <T/F>\tFix quality scores [Default = F]\e[0m"
  echo -e "\n\e[96mRequires\e[0m"
  echo -e "\e[92mBWA\e[0m"
