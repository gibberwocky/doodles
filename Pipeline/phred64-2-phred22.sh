...
#  echo -e "\e[91m[1/${STEPS}] BWA:Map reads [BWA MEM] \n\t\e[94m\e[1m<- \e[0m\e[92m${REF} \n\t\e[94m\e[1m<- \e[0m\e[92m${IN}/${READS_1} \n\t\e[94m\e[1m<- \e[0m\e[92m${IN}/${READS_2} \n\t\e[94m\e[1m-> \e[0m\e[96m${OUT}/${SAMPLE}/${SAMPLE}.sam \e[0m"
  mv ${IN}/${SAMPLE}_R1.fastq ${IN}/${SAMPLE}_p64_R1.fastq
  mv ${IN}/${SAMPLE}_R2.fastq ${IN}/${SAMPLE}_p64_R2.fastq
  ${EMBOSS}/seqret fastq-illumina::${IN}/${SAMPLE}_p64_R1.fastq fastq::${IN}/${SAMPLE}_R1.fastq
  ${EMBOSS}/seqret fastq-illumina::${IN}/${SAMPLE}_p64_R2.fastq fastq::${IN}/${SAMPLE}_R2.fastq
  bgzip ${IN}/${SAMPLE}_R1.fastq
  bgzip ${IN}/${SAMPLE}_R2.fastq
fi
if [ "${PAIRED}" = "F" ]; then
...
bgzip ${IN}/${SAMPLE}_p64_R1.fastq
bgzip ${IN}/${SAMPLE}_p64_R2.fastq
