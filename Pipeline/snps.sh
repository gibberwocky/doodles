...
# ==============================================================================
echo -e "\n\e[1m\e[34m====================================\e[0m"
echo -e "\e[93m\e[1mSeqApiPop\e[0m\e[93m: SNP calling\e[0m"
...
usage()
{
  ...
  echo -e "\n\e[96mDetails\e[0m"
  echo -e "\e[92mThis pipeline has been developed to call SNPs from NGS data generated for the SeqApiPop project. All of the parameters in the parameter file required to be set."
  echo -e "\n\e[96mOPTIONS:\e[0m"
...
bcftools view --types snps -M 2 -g ^het -O v \
