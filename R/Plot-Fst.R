...
setwd("/home/dave/Copy/HoneyBee/Analyses/selection/R-fst")

fname <- "Fst.out"
#fname <- "Fst-10k-25step.out"
#fname <- "Fst-20k-25step.out"
#fname <- "Fst-40k-25step.out"
#fname <- "Fst-60k-25step.out"
#fname <- "Fst-80k-25step.out"
#fname <- "Fst-100k-25step.out"
#fname <- "Fst-120k-25step.out"
#fname <- "Fst-140k-25step.out"
#fname <- "Fst-160k-25step.out"
...
#dat[which(dat$chr < 17),9] <- (dat$Fst_mean - mean(dat[which(dat$chr < 17),]$Fst_mean, na.rm=T) ) / sd(dat[which(dat$chr < 17),]$Fst_mean, na.rm=T)
dat[which(dat$chr < 17),9] <- dat$Fst_mean
names(dat)[9] <- "Val"
plot_x_label <- "Fst"
